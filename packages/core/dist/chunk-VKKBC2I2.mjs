...
var DropZoneRenderItem = ({
  ...
  const props = useSlots(config, item, (slotProps) => /* @__PURE__ */ jsx26(
    SlotRenderPure,
...
var DropZoneRender = forwardRef3(
  function DropZoneRenderInternal({ className, style, zone }, ref) {
    ...
    const items = content.map((item) => {
      const Component = config.components[item.type];
      return Component ? /* @__PURE__ */ jsx26(
        DropZoneRenderItem,
        {
          config,
          item,
    ...
    if ((ctx == null ? void 0 : ctx.mode) === "render") {
      return /* @__PURE__ */ jsx26(Fragment7, { children: items });
    }
    return /* @__PURE__ */ jsx26("div", { className, style, ref, children: items });
  }
);
